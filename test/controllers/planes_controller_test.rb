...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { datetime: @plane.datetime, description: @plane.description, elevation: @plane.elevation, id: @plane.id, latitude: @plane.latitude, longitude: @plane.longitude } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { datetime: @plane.datetime, description: @plane.description, elevation: @plane.elevation, id: @plane.id, latitude: @plane.latitude, longitude: @plane.longitude } }
